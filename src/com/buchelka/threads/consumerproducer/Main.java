package com.buchelka.threads.consumerproducer;
    ...
    public  String read() {
        ...
        try {
            if (lock.tryLock(3, TimeUnit.SECONDS)) {
                ...
                System.out.println("*** Read blocked-----Could not acquire lock" + lock);
                hasMessage = false;
            }
        }catch (InterruptedException e) {
            throw new RuntimeException(e);
    ...
    public void write(String message) {
        try {
            if (lock.tryLock(3, TimeUnit.SECONDS)) {
                ...
                System.out.println("*** Write blocked-----Could not acquire lock" + lock);
                hasMessage = true;
                this.message = message;
            }
        }catch (InterruptedException e) {
