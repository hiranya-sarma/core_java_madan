...
public class LinkedList {
    ...
    public Node remove(int index){
        ...
        Node temp = prev.next;
        prev.next = temp.next;  // set the next node of the previous node to the next node of the node to be removed
        temp.next = null;  // set the next node of the node to be removed to null
        length--;
        return temp;
    }
    public void reverse(){
